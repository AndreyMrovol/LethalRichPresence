...
public class ConfigManager
{
    ...
    private ConfigManager(ConfigFile config)
    {
        ...
        ActivityPlayers = config.Bind(
            "Presence",
            "ActivityPlayers",
            true,
            "Display number of players"
        );
        DisplayLivingPlayers = config.Bind(
            "Presence",
            "DisplayLivingPlayers",
            false,
            "Display amount of currently alive players in the rich presence."
        );

        ActivityDetails = config.Bind(
            "Presence",
            "ActivityDetails",
            "%quotacountifier% quota: %quota% (%collected% on ship)",
            "The details of the rich presence."
        );
        ActivityState = config.Bind(
            "Presence",
            "ActivityState",
            "%timeleft% left, playing %onlineorlan%",
            "The state of the rich presence."
        );

        OrbitLargeImage = config.Bind(
            "Presence.InOrbit",
            "LargeImage",
            "inorbit",
            "The large image key for the rich presence."
        );
        OrbitLargeText = config.Bind(
            "Presence.InOrbit",
            "LargeText",
            "In Orbit",
            "The large image tooltip for the rich presence."
        );
        OrbitSmallImage = config.Bind(
            "Presence.InOrbit",
            "SmallImage",
            "%&currentplanet%",
            "The small image key for the rich presence."
        );
        OrbitSmallText = config.Bind(
            "Presence.InOrbit",
            "SmallText",
            "Orbiting %currentplanet%",
            "The small image tooltip for the rich presence."
        );

        PlanetLargeImage = config.Bind(
            "Presence.OnPlanet",
            "LargeImage",
            "%&currentplanet%",
            "The large image key for the rich presence."
        );
        PlanetLargeText = config.Bind(
            "Presence.OnPlanet",
            "LargeText",
            "%currentplanet%",
            "The large image tooltip for the rich presence."
        );
        PlanetSmallImage = config.Bind(
            "Presence.OnPlanet",
            "SmallImage",
            "%&currentweather%",
            "The small image key for the rich presence."
        );
        PlanetSmallText = config.Bind(
            "Presence.OnPlanet",
            "SmallText",
            "%currentweather%",
            "The small image tooltip for the rich presence."
        ...
        FiredSequenceLargeImage = config.Bind(
            "Presence.FiredSequence",
            "LargeImage",
            "fired",
            "The large image key for the rich presence."
        );
        ...
        Debug = config.Bind(
            ...
            "Debug logs",
            false,
            "Enable debug logging: resolving placeholders etc."
        );
    }
}
